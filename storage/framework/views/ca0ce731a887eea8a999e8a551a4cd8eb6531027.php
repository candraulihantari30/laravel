    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
               ...
               <h2>NAMA: <?php echo e($data['krama']['nama']); ?></h2>
               <h2>JABATAN: <?php echo e($data['krama']['jabatan']); ?></h2>
               <h2>KETERANGAN: <?php echo e($data['krama']['keterangan']); ?></h2>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\belajar-laravel\resources\views/admin/beranda.blade.php ENDPATH**/ ?>